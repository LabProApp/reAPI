...
public class BankLoan {
    ...
    public BankLoan(String bankName, double interestRate, int tenureYears,
                    String contactNumber, String websiteUrl,
    ...
    public int getMinCibilScore() { return minCibilScore; }
    public void setMinCibilScore(int minCibilScore) { this.minCibilScore = minCibilScore; }
