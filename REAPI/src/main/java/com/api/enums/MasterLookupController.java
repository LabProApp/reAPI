...
@Tag(name = "Master Lookup APIs", description = "Reference data — master lookup values and enum constants")
public class MasterLookupController {
	...
	@Operation(summary = "Get master lookup values by type")
	...
	@Operation(summary = "Get child lookup values for a parent entry")
	...
	@Operation(summary = "Get enum constants by name")
	...
	@Operation(summary = "Get all enum constants grouped by type")
	@GetMapping("/allenums")
