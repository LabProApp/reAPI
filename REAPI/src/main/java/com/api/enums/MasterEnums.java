...
public final class MasterEnums implements BaseEnum {
	...
	public enum LoanType {
		HOME, LAP, BALANCE_TRANSFER

	}

	@Getter
	public enum InquiryType {
		HOME_LOAN, LAP, BALANCE_TRANSFER, BUY_HOME, SELL_HOME,DOCUMENT_SERVICES,LOAN_TRANSFER,HOME_RENTAL,COMMERCIAL;
	...
	public enum UserStatusEnum {
		ACTIVE, CANCELLED, TERMINATED, PENDING;
	...
	public enum PropertyTypeEnum {
		PLOT, APARTMENT, HOUSE, BUILDER_FLOOR,PG, OFFICE, SHOP, SHOWROOM, PLOT_SHOP, CO_WORKING, AGRICULTURAL;
	...
	public enum RelationTypeEnum {
		AGENT, CLIENT, PROSPECT_CLIENT, EMPLOYEE;
