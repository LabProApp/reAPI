...
public class NotificationController {
    ...
    @Operation(summary = "Send SMS to a mobile number")
    @PostMapping("/sms")
    ...
    @Operation(summary = "Send WhatsApp message")
    ...
    @Operation(summary = "Send notification using a named template")
    ...
    @Operation(summary = "List all available notification templates")
    @GetMapping("/templates")
    public ResponseEntity<Set<TemplateKey>> listTemplates() {
        return ResponseEntity.ok(TemplateRegistry.all().keySet());
    }

    @Operation(summary = "Re-trigger lead inquiry notification")
    ...
    @Operation(summary = "Re-trigger lead status notification")
    ...
    @Operation(summary = "Send welcome notification to a user")
